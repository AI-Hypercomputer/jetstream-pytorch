...
class FeedForward(nn.Module):
  ...
  def __init__(
    ...
    Args:
        ...
        multiple_of (int): Value to ensure hidden dimension is a multiple of
          this value.
...
class TransformerBlock(nn.Module):
  ...
  def forward(
    ...
    Args:
        ...
        mask (torch.Tensor, optional): Masking tensor for attention. Defaults to
          None.

    Returns:
        torch.Tensor: Output tensor after applying attention and feedforward
        layers.
    """
