...
class ModelComponentTest(unittest.TestCase):
    ...
    def _make_one_cache_for_generate(self, env, pos):
        ...
        cache_array_k, cache_array_v = torchjax.to_torch((cache_array_k, cache_array_v))
    ...
    def test_attention(self):
        ...
        cache_decode.cache_k._elem = cache_decode.cache_k._elem.at[:, :, :pos, :].set(
            cache.cache_k._elem
        )

        cache_decode.cache_v._elem = cache_decode.cache_v._elem.at[:, :, :pos, :].set(
            cache.cache_v._elem
        )
