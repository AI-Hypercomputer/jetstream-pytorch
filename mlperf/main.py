...
def get_args():
    ...
    parser.add_argument("--api-url", type=str, default=None, help="SAX published model path.")
    ...
    parser.add_argument("--input-mode", type=str, choices=["text", "tokenized"], default="tokenized")
    parser.add_argument("--output-mode", type=str, choices=["text", "tokenized"], default="tokenized")
    parser.add_argument("--max-output-len", type=int, default=1024, help="Maximum output len")
    ...
    parser.add_argument("--perf-count-override", type=int, default=None, help="Overwrite number of samples to use in benchmark.")
    ...
    parser.add_argument("--num-client-threads", type=int, default=200, help="Number of client threads to use")
    parser.add_argument("--batch-size-exp", type=int, default=6, help="")
    parser.add_argument("--log-pred-outputs", action="store_true", help="")
    parser.add_argument("--log-interval", type=int, default=1000, help="Logging interval in seconds")
    parser.add_argument("--user-conf-override-path", type=str, default="", help="When given overrides the default user.conf path")
...
def main():
    ...
    sut = backend.SUT(
        ...
        pred_outputs_log_path=os.path.join(args.output_log_dir, "pred_outputs_logger.json") if args.log_pred_outputs else None
    )
