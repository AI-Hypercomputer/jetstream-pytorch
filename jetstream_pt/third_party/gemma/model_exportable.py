...
class GemmaModel(nn.Module):
    ...
    def __init__(self, config: gemma_config.GemmaConfig):
        ...
        self.embedder = Embedding(self.vocab_size, config.hidden_size, config.quant)
    ...
    def forward(
        ...
        caches: list[cache_manager.KVCachePrefill],
        mask: torch.Tensor,
    ) -> torch.Tensor:
        kv_caches = []
        for kv_cache in caches:
            kv_caches.append(Tuple(kv_cache.cache_k, kv_cache.cache_v))
