...
class Attention(nn.Module):
  ...
  def __init__(self, n_heads, n_kv_heads, head_dim, hidden_size, device, env):
    ...
    # LinearLayer = WeightOnlyInt8Linear if env.enable_weight_quantization else nn.Linear
    LinearLayer = WeightOnlyInt4Linear if env.enable_weight_quantization else nn.Linear
